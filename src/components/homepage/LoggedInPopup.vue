...
>
  ...
  <div class="bg-[url(@/images/fade.svg)] relative bg-repeat-x flex-col flex gap-2 max-h-64 overflow-y-auto">
    ...
    <div class="flex gap-2 items-center p-3 px-2 mx-2 bg-black bg-opacity-20 rounded-md">
    ...
    <div class="flex z-10 gap-2 items-center p-3 px-2 mx-2 mb-2 bg-black bg-opacity-10 rounded-md">
      <img src="@/images/KABOOMshshsh.svg" class="w-6" alt="">

...
<template>
    <HelpMenu
        v-if="helpMenuOpen"
        @close-popup="helpMenuOpen = false"
    />
    <section class="flex z-50 justify-center items-center mt-36 w-full h-24 text-white bg-lof-200">
        <div class="flex items-center">
            <img src="@/images/ggprof.webp" class="w-14 rounded-full aspect-square" alt="">
            <div class="ml-3">
                <p class="font-thin leading-[8px] text-xs opacity-40">GD Lists by</p>

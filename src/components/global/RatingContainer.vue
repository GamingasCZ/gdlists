...
<template>
	<section class="flex flex-col gap-2">
	    <div class="grid bg-black bg-opacity-80 rounded-md backdrop-blur-sm ratingDetails">
            <span class="text-sm text-center opacity-0 transition-opacity duration-200">{{ hoveredRatingName }}</span>
            <div class="flex">

...
<template>
  ...
  >
    <img v-if="BGhash" :style="{mask: 'linear-gradient(90deg,transparent,black)'}" class="isolate absolute inset-0 w-full opacity-40 mix-blend-luminosity" :src="`${uc}/userContent/${BGuploader}/${BGhash}-mthumb.webp`" alt="">

    ...
    <section
        ...
        <div class="flex flex-col leading-none">
            <div class="flex gap-1 items-center cursor-text group">
                <input autocomplete="off" maxlength="25" type="text" :placeholder="$t('collabTools.collabName')"
        ...
        <div v-if="onSavesPage" class="flex ml-auto">
            <RouterLink :to="`/${save.listID}`" @click.stop.prevent="" class="box-border p-2 w-10 bg-black bg-opacity-40 rounded-md button" v-if="save.listID">
            ...
            <button class="box-border p-2 ml-2 w-10 bg-black bg-opacity-40 rounded-md button"
                @click.stop.prevent="emit('removeCollab', collIndex!)">

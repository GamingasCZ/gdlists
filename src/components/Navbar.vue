...
<template>
  ...
  >
    ...
    <RouterLink
        ...
        data-ind="1"
        class="flex flex-col gap-2 items-center px-4 bg-black bg-opacity-20 transition-colors max-sm:gap-1 max-sm:pb-1 hover:bg-opacity-40 md:flex-row websiteLink"
